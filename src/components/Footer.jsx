      ...
      <div className="container">
        <div className="footer-grid">
          <div className="footer-brand">
            <img src="/logo-dark.png" alt="Swanix Brand Development" className="footer-logo" />
            ...
            <div className="footer-social">
              <a href="https://www.instagram.com/swanixbranddevelopment/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              ...
              <a href="https://www.facebook.com/61591586217898/" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="footer-links">
            ...
            <div className="footer-contact-item">
              <span className="footer-contact-icon">📧</span>
              <a href="mailto:swanixbranddevelopment@gmail.com">swanixbranddevelopment@gmail.com</a>
            </div>
          </div>
        </div>
